...
\begin{definition}
	...
	An object $ X $ of $ C $
	is said to be \defn{$ \kappa $-compact below $ \lambda $} if and only if
	...
	A category $C$ is
	\defn{$\kappa$-accessible below $ \lambda $} if and only if
	...
	A category $C$ is
	\defn{$\kappa$-presentable below $ \lambda $}
	if and only if
